...
class ExercisesControllerTest < ActionController::TestCase
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post :create, exercise: { length: @exercise.length, place: @exercise.place, start: @exercise.start }
    end
  ...
  test "should update exercise" do
    patch :update, id: @exercise, exercise: { length: @exercise.length, place: @exercise.place, start: @exercise.start }
    assert_redirected_to exercise_path(assigns(:exercise))
  end
